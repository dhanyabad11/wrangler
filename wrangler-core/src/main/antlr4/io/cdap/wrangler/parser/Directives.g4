...
fragment TIME_UNIT : ('NS' | 'MS' | 'S' | 'M' | 'H' | 'D' | 'ns' | 'ms' | 's' | 'm' | 'h' | 'd');
fragment DECIMAL_NUMBER : Digit+ ('.' Digit+)?;

BYTE_SIZE : DECIMAL_NUMBER BYTE_UNIT;
TIME_DURATION : DECIMAL_NUMBER TIME_UNIT;
